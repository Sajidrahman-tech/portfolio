...
export const metadata = {
  title: "Saajid Rahman | Portfolio",
  description: "Saajid Rahman Software Developer with 2 years of experience.",
  verification: {
...
{/* Blob 2 (left) */}
<div
  className="bg-teal-200 absolute top-[-1rem] -z-10 left-[-35rem]
             h-[31.25rem] w-[50rem] rounded-full blur-[10rem]
             sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem]
             xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-teal-800/40"
/>
