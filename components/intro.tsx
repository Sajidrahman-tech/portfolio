    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/Profile_Picc.jpeg"         
              alt="Saajid Rahman portrait"
              width={192}
              height={192}
              quality={95}
              priority
      ...
      >
        <span className="font-bold">Hello, I’m Saajid Rahman</span> </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="/Mohamed_Saajid_Resume.pdf"    // TODO: export/rename your resume file in /public
          download
        ...
        <a
          ...
          href="https://www.linkedin.com/in/sajid-rahman27/" 
          target="_blank"
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/saajid_rahman/"        
          target="_blank"
          rel="noreferrer noopener"
